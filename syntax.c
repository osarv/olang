...
struct syntaxRule rules[] = {
    [SNTX_TOP_DECL] = {"SNTX_TOP_DECL", "SNTX_TYPE_DECL|SNTX_IMPORT|SNTX_ERROR_DECL|SNTX_FUNC_DEF|SNTX_VAR_DECL"},
    ...
    [SNTX_STMNT] = {"SNTX_STMNT", "SNTX_VAR_DECL|SNTX_STMNT_ASSIGN|SNTX_STMNT_IF|SNTX_STMNT_FOR|SNTX_STMNT_DO|"
        "SNTX_STMNT_MATCH|SNTX_STMNT_RET|SNTX_STMNT_EXIT|SNTX_STMNT_EXPR"},
    ...
    [SNTX_EXPR_PRIMARY] = {"SNTX_EXPR_PRIMARY", "TOK_BOOL_LIT|TOK_INT_LIT|TOK_FLOAT_LIT|TOK_CHAR_LIT|TOK_STR_LIT|"
        "(TOK_IDEN SNTX_EXPR_CALL)|TOK_IDEN|(TOK_PAREN_O SNTX_EXPR TOK_PAREN_C)"},
